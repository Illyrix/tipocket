...
require (
	...
	github.com/pingcap/tidb-operator v0.0.0-20200226121905-0a090b11c7e8
...
replace github.com/prometheus/prometheus => github.com/prometheus/prometheus v1.8.2-0.20200110114423-1e64d757f711
